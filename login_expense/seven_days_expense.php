...
<div class="container">
    <div class="row">
        <div class="col-12 py-5">
            <h1 class="text-center margin_yy hh1">Last Week Expenses</h1>
        </div>
    ...
    <tbody>
        <?php
        //seven days date and show data 

        
        // $today_date = date("Y-m-d");
        // // if you went to see
        // $previous_seven_day_date = date("Y-m-d",strtotime($today_date . "-7 days"));

        $today_date = date("Y-m-d");
        $previous_seven_day_date = date("Y-m-d",strtotime($today_date . "-1 week"));


        $fetch_expense = "SELECT * FROM expenses_info WHERE item_date BETWEEN '$previous_seven_day_date' AND '$today_date' ORDER BY item_date ASC";
