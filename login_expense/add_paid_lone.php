...
if(isset($_REQUEST['add_item'])){
    ...
    $sql = "INSERT INTO lone_paid (item_name, item_price, item_date, item_details) VALUES ('$item_name', '$item_price', '$item_date', '$item_details')";
                ...
                <div class="col-12">
                        <form method="POST">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <div class="col-md-12 mb-3">
                                    <button type="submit" class="btn btn-primary w-100" name="add_item">Paid lone</button>
                                </div>
                            </div>
                     </form>
                </div>
