...
if(isset($_REQUEST['edit_income_id'])){

    $edit_income_id = $_REQUEST['edit_income_id'];

    $fetch_query = "SELECT * FROM income_info WHERE item_id = $edit_income_id";
...
if(isset($_REQUEST['update_item'])){
    ...
    $update_query = "UPDATE `income_info` SET `item_name`='$update_item_name',`item_price`='$update_item_price',`item_date`='$update_item_date',`item_details`='$update_item_details' WHERE item_id =$edit_income_id ";
