...
<div class="container">
    <form>
        <div class="row">
            <div class="col-md-12">
                <h2 class="text-center display-6 fw-bold py-3 margin_yy hh1">Paid Lone Report</h2>
            </div>
    ...
    <tbody>
        <?php
            if(isset($_REQUEST['search'])){
                ...
                $search_lone = "SELECT * FROM lone_paid WHERE item_date BETWEEN '$from_date' AND '$to_date' ";
