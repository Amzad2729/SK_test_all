...
if(isset($_REQUEST['edit_expense_id'])){
    ...
    $fetch_query = "SELECT * FROM expenses_info WHERE item_id = $edit_expense_id";
...
if(isset($_REQUEST['update_item'])){
    ...
    $update_query = "UPDATE `expenses_info` SET `item_name`='$update_item_name',`item_price`='$update_item_price',`item_date`='$update_item_date',`item_details`='$update_item_details' WHERE item_id =$edit_expense_id ";
    $run_update_query = mysqli_query($conn,$update_query);

    if($run_update_query){
        my_alert("success", "Expense updated successfully");
    }else{
        my_alert("danger", "Something wrong!, Expense not update");
    }
}
                ...
                <div class="col-12">
                        <form method="POST">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <div class="col-md-12 mb-3">
                                    <!-- <button type="submit" class="btn btn-primary w-100" name="update_item">Update Expense</button> -->
                                </div>
                            </div>
                     </form>
                </div>
