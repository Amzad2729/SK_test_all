...
<div class="container">
    <div class="row">
        <div class="col-12 py-5">
            <h1 class="text-center margin_yy hh1">Today Income</h1>
        </div>
    ...
    <tbody>
        ...
        $fetch_income = "SELECT * FROM income_info WHERE item_date = '$today_date' ORDER BY item_date ASC";
        ...
        if(mysqli_num_rows($run_fetch_income) > 0){
            ...
            ?>
                <tr>
                    <td colspan="6">
                        <h3 class="text-danger text-center">No income record found here!</h3>
                    </td>
                </tr>
            <?php
        }
